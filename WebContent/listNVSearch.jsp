...
<body>
	...
	<div id="main">
		...
		<hr width="all" />
		<a href="doSearch"><input type="submit" value="Back" id="btn1"></a>
		<table border="0" cellpadding="2" cellspacing="10">
		<tr>
			<td colspan="6" class="title">List Employees Search</td>
		</tr>
		<tr>
		...
		<c:forEach items="${listNVSearch}" var="list">
			<tr>
				...
				<td class="title2"><c:out value="${list.getAddress()}"></c:out> </td>
				<td class="title2"><c:out value="${list.getPosition()}"></c:out> </td>
				<td class="title2"><c:out value="${list.getDescription()}"></c:out> </td>
			</tr>
		</c:forEach>
	</table>
	</div>
